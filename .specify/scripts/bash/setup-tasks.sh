...
# Resolve through the override stack when the installed Spec Kit common
# helpers provide it. Older/partially-upgraded 0.13 installations do not
# define resolve_template even though this generated script calls it, so use
# the checked-in core template as the compatible final fallback.
